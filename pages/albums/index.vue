    ...
    <b-container fluid style="margin-top: 5rem;">
        <b-row>
            <b-col cols="12" class="mb-2">
                <div class="heading">
                    <h1>Pashto Album, Pashto Gane, Pashto Song</h1>
                </div>
                <div class="sub-heading">
                    <h2>This page Pashto Album will help you to find your favourite Pashto Gane Album.</h2>
                </div>
            </b-col>
...
<script>
    ...
    export default {
        asyncData ({ params }) {
            return axios.get('https://dev.pashtoaudios.com/api/v1/albums', {
                    params: {
                        page: 1,
                        per_page: 12
                    }
        ...
        head () {
            return {
                title: "Pashto Album, Pashto Gane, Pashto Song - PashtoGane.com",
                meta: [
        ...
        methods: {
            getCategories: function () {
                ...
                axios.get('https://dev.pashtoaudios.com/api/v1/albums', {
                    params: {
                        page: this.page,
                        per_page: 12
                    }
